...
public class Floor0 {
    ...
    private boolean nextLevelCheck = false;
    ...
    public void introductionLevel(windowlayout a){
        ...
        while(floor0){
            ...
            if(sentCommand == true){
                ...
                if(nextLevelCheck && floorMap[x] == floorMap[1]){
                    a.textArea.append("  Would you like to proceed to the next level?");
                    if(a.playerStringForObjects.equalsIgnoreCase("yes")){
                        ...
                        timerForFinish.schedule(timer, 7000);
                        floor0 = false;
                    }
                    if(a.playerStringForObjects.equalsIgnoreCase("no")){
    ...
    public void endLevel(windowlayout a){
